...
public class Button
{
    ...
    public final static Button BTN_TILT = new Button();
    ...
    public static final Button BTN_NOLLTRACK = new Button();
    ...
    public static final Button BTN_SHOOTPID = new Button();
    public static final Button BTN_HOODCOMP = new Button();
    public static final Button BTN_FOLLOWER = new Button();
